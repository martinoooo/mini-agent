...
相比 Step 17 新增:
  - Cron 调度器：后台线程轮询到期任务
  - add_reminder / list_reminders / delete_reminder 工具
  - /cron 命令查看定时任务
  - /log 命令查看日志文件路径和最近日志
